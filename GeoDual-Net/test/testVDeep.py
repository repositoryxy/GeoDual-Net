...
MODEL_WEIGHT_PATH = r"/root/autodl-tmp/Geo-SegViT/ComparedModels_U/DeepLab_P/best.pth"
...
OUTPUT_DIR = r'/root/autodl-tmp/Geo-SegViT/ComparedModels/TestResults/DeeplabV3Plus_P'
...
# ======================== 2. Data Loading ========================
class DeeplabTestDataset(torch.utils.data.Dataset):
...
def vis_deeplab_result(img, mask, pred, file_name, save_path, mean, std):
...
def main():
    ...
    test_dataset = DeeplabTestDataset(ROOT_PATH, transform=transform)
    ...
    metrics = DeeplabMetrics(NUM_CLASSES)
    vis_count = 0
